$(document).ready(function () {
  ...
  $(".input-group-btn button").click(function () {
    ...
    // var imglogo = $form.find('#imglogo').val();
        ...
        var options = {
            ...
            // image:'http://192.168.0.121:8000/assets/images/user_profile.png',
                    ...
                    success: function (data) {
                        if (data.success) {
                            ...
                            swal({
                                ...
                                text: data.error || "An error occurred while processing your payment. Please try again.",
                                icon: "error",
                            });
                        }
                    },
        ...
        rzp1.on('payment.failed', function (response) {
                ...
                swal({
                    title: "Payment Failed",
                    text: response.error.description || "Something went wrong with your payment. Please try again.",
                    icon: "error",
                    timer: 10000,
                    buttons: false
                });
                ...
                $.ajax({
                    ...
                    success: function () {
                        // console.log("Failed payment data stored successfully.");
                    },
                    error: function () {
                        // console.log("Failed to store payment failure data.");
                    }
                });
