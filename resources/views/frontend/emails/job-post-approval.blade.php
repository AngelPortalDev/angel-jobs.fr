...
<head>
    ...
    <title>Job Post Approved Successfully</title>
    ...
    <div class="container">
        <div class="row align-items-center justify-content-center">
            ...
            <div class="col-md-12 ps-md-4 my-md-4 border-md-start">
                ...
                <p>Dear #Name#, <br></p>
                <p>We are pleased to inform you that your <span style="font-weight: 600">#Job_title# job post has been approved and is now live on Angel-Jobs.</span> Candidates can start applying right away.</p>
