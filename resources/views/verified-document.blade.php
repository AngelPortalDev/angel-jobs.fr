...
<body>
    <div class="container">
         ...
         <h2><span style="color: #d72f37;font-weight: 600;">{{session('msg')}}</span></h2>
            @endif
        <img class="logo" src="{{ asset('images/angel-Jobs-France.png')}}" alt="Angel Jobs Malta Logo">
        <h2 style="font-weight: 600;"> <span style="font-size: 40px; color: #23a0d2;font-weight: 700;">Angel Jobs Malta</span></h2>
        
        <p class="message">Now Empolyer Document verified <br> They are now part of the Angel Jobs Malta community.</p>
         </div>
</body>
</html>
