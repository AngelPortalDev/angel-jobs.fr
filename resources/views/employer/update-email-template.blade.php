						...
						<div class="col-xl-9 col-lg-9 m-b30">
							<div class="job-bx clearfix">
								<div class="job-bx-title clearfix">
									<h5 class="font-weight-700 float-start text-uppercase">Update Email Templates</h5>
								...
								<div class="form">
                                    ...
                                    <div class="container">
                                        <form id="updateemail" >
                                            <input type="text" class="form-control" value="{{base64_encode($templData->id)}}" name="temp_id" id="temp_id" hidden>
                                        <div class="row g-2">
                                            <div class="  col-md-6">
                                            ...
                                            <div class="  col-md-6">
                                                ...
                                                <input type="text" class="form-control" placeholder=""
                                                    name="template_name" id="template_name" value="{!! htmlspecialchars_decode($templData->template_name) !!}">
                                                {{-- @error('template_name')
                                                    <span style="color:red;text-transform:capitalize">{{ $message }}</span>
                                                @enderror --}}
                                                <span id="template_name_error" style="color:red;display:none;">
                                                    <small>
                                                        <i>Select Type </i>
                                                    </small>
                                                </span>
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <input type="text" class="form-control"  placeholder=""
                                                    name="email_subject" id="email_subject" value="{!! htmlspecialchars_decode($templData->email_subject) !!}">
                                                {{-- @error('email_subject')
                                                    <span style="color:red;text-transform:capitalize">{{ $message }}</span>
                                                @enderror --}}
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div id="quill-editor" class="mb-3" style="height: 300px;">
                                                    {!!htmlspecialchars_decode($templData->email_content) !!}
													</div>
													
													<input type="hidden" name="email_content" id="email_content" value="{!!htmlspecialchars_decode($templData->email_content) !!}">
                                                ...
                                                <div class="">
                                                    <button type="button" id="postemail" class="btn btn-primary mb-4 me-2">Update</button>
