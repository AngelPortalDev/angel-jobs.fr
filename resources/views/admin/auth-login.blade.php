                    ...
                    <div class="card overflow-hidden">
                        <div class="row g-0">
                            <div class="col-lg-6 d-none d-lg-block p-2">
                                <img src="{{ asset('admin/assets/images/login-bg.png')}}" alt="" class="img-fluid rounded h-100">
                            </div>
                            <div class="col-lg-6">
                                    ...
                                    <div class="p-4 my-auto">
                                        ...
                                        <form method="POST" id="adminLoginForm">
                                            <div class="mb-3">
                                                ...
                                                <span id="ad_login_user_error" style="color:red;display:none;">
                                                <small>
                                                    <i>Please Provide Email </i>
                                                </small></span>
                                            </div>
                                            <div class="mb-3">
                                                {{-- <a href="auth-reset-password.php" class="text-muted float-end"><small>Forgot
                                                        your
                                                        password?</small></a> --}}
                                                <label for="password" class="form-label">Password</label>
                                                <input class="form-control" type="password" id="password" name="password" placeholder="Enter your password">
                                                  <span id="ad_login_pass_error" style="color:red;display:none;">
                                                <small>
                                            ...
                                            <div class="mb-0 text-start">
                                                <button class="btn btn-soft-primary w-100" id="adminLogin" type="button" style="background-color: #e2f6ff; color: #03A9F4;"><i class="ri-login-circle-fill me-1"></i> <span class="fw-bold">Log
                                                        In</span> </button>
                                            </div>
