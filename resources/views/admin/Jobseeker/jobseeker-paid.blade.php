                                        ...
                                        <tbody>
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript: void(0);" class="text-reset fs-16 px-1"> 
                                                        <i class="ri-checkbox-fill" data-bs-toggle="modal" data-bs-target="#modify-plan-modal"></i></a>
                                                </td>
            ...
            <div class="modal-body p-2">
                ...
                <div class="text-center">
                    ...
                    <button type="button" class="btn btn-light"
                     ...
                     <div id="modify-plan-modal" class="modal fade" tabindex="-1" role="dialog"
                     aria-hidden="true">
                     <div class="modal-dialog">
                         <div class="modal-content">

                             <div class="modal-header">
                                 <h4 class="modal-title" id="topModalLabel">Modify Plan</h4>
                                 <button type="button" class="btn-close" data-bs-dismiss="modal"
                                     aria-label="Close"></button>
                             </div>
